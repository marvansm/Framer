...
const Footer = () => {
  return <div>
    <footer class="bg-[#161616] text-white pt-16 pb-8 px-6 md:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 gap-y-12 md:gap-x-8">
            ...
            <div
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-sm hover:text-gray-300 transition-colors">Start a Project</a></li>
                        ...
                        <li><a href="#" class="text-sm hover:text-gray-300 transition-colors">Drop Us a Note</a></li>
                    </ul>
                </div>
                <div>
